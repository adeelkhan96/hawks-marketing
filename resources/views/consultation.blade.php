...
@section('meta-description','Expert business and marketing consultation by Hawks Marketing â€” strategic guidance, market insights, and actionable recommendations to help your business achieve measurable growth.')
@section('content')
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-5 mt-4 mt-lg-0">
          <div class="intro-highlight">
            ...
            <p style="margin-bottom:14px;"><strong>{{ PC::getValue($p, 'highlight', 'p1_label', 'Expert Guidance') }}</strong> â€” {{ PC::getValue($p, 'highlight', 'p1_text', 'Strategic advice from experienced professionals with deep knowledge of digital marketing and business growth.') }}</p>
            <p style="margin-bottom:14px;"><strong>{{ PC::getValue($p, 'highlight', 'p2_label', 'Tailored to You') }}</strong> â€” {{ PC::getValue($p, 'highlight', 'p2_text', 'Recommendations built around your specific situation, goals, and challenges â€” not generic advice.') }}</p>
            <p style="margin-bottom:0;"><strong>{{ PC::getValue($p, 'highlight', 'p3_label', 'Actionable') }}</strong> â€” {{ PC::getValue($p, 'highlight', 'p3_text', 'Every session ends with clear next steps you can implement immediately to see results.') }}</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
            ...
            <p>{{ PC::getValue($p, 'services', 's1_desc', 'Expert guidance on your overall digital marketing direction â€” channel selection, budget allocation, campaign priorities, and go-to-market approaches.') }}</p>
          </div>
        </div>
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
            ...
            <p>{{ PC::getValue($p, 'services', 's2_desc', 'Strategic advice on brand identity, positioning, and messaging â€” helping you build a brand that connects with your audience and differentiates you in the market.') }}</p>
          </div>
        </div>
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
            ...
            <p>{{ PC::getValue($p, 'services', 's3_desc', 'Structured planning sessions to map out your digital growth roadmap â€” identifying quick wins and long-term strategies to scale your online presence and revenue.') }}</p>
          </div>
        </div>
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
