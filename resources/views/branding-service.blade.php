...
@section('meta-description','Complete branding solutions by Hawks Marketing — visual identity, brand assets, color systems, typography, and guidelines that build recognition and trust.')
@section('content')
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-5 mt-4 mt-lg-0">
          <div class="intro-highlight">
            ...
            <p style="margin-bottom:14px;"><strong>{{ PC::getValue($p, 'highlight', 'p1_label', 'Holistic Approach') }}</strong> — {{ PC::getValue($p, 'highlight', 'p1_text', 'We cover every dimension of brand identity — visual, verbal, and strategic — in one integrated process.') }}</p>
            <p style="margin-bottom:14px;"><strong>{{ PC::getValue($p, 'highlight', 'p2_label', 'Built to Last') }}</strong> — {{ PC::getValue($p, 'highlight', 'p2_text', 'Brand identities designed for longevity, not trends, ensuring relevance as your business grows.') }}</p>
            <p style="margin-bottom:0;"><strong>{{ PC::getValue($p, 'highlight', 'p3_label', 'Consistent Across All Touchpoints') }}</strong> — {{ PC::getValue($p, 'highlight', 'p3_text', 'We ensure your brand looks and feels the same everywhere it appears.') }}</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
            ...
            <p>{{ PC::getValue($p, 'services', 's2_desc', 'All the branded materials your business needs — business cards, letterheads, social media templates, email signatures, and more.') }}</p>
          </div>
        </div>
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="service-item">
            ...
            <p>{{ PC::getValue($p, 'services', 's4_desc', 'Ensuring your brand is applied correctly and consistently across all digital and physical touchpoints — protecting and strengthening your brand equity.') }}</p>
          </div>
        </div>
      </div>
    </div>
