...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <button wire:click="startCreate" class="btn btn-sm" style="background:#ff511a;color:#fff;font-weight:600;border-radius:8px;padding:8px 18px;">
...
<div class="text-center py-5" style="background:#f8f9fc;border-radius:14px;">
    <i class="fas fa-star" style="font-size:36px;color:#ff511a;opacity:.4;margin-bottom:12px;display:block;"></i>
        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <p style="font-size:13px;color:#ff511a;font-weight:600;margin-bottom:6px;"><i class="fas fa-trophy me-1"></i>{{ $story->tagline }}</p>
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
            <div class="card-body p-4">
                <h6 style="font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:#212741;margin-bottom:20px;padding-bottom:10px;border-bottom:2px solid rgba(255,81,26,.15);">
                    <i class="fas fa-building me-2" style="color:#ff511a;"></i>Client & Industry
                </h6>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label" style="font-size:13px;font-weight:600;color:#374151;">Client Name <span style="color:#ff511a;">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label" style="font-size:13px;font-weight:600;color:#374151;">Industry <span style="color:#ff511a;">*</span></label>
                    ...
                    <div class="col-12">
                        <label class="form-label" style="font-size:13px;font-weight:600;color:#374151;">Win Tagline <span style="color:#ff511a;">*</span></label>
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
            <div class="card-body p-4">
                <h6 style="font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:#212741;margin-bottom:20px;padding-bottom:10px;border-bottom:2px solid rgba(255,81,26,.15);">
                    <i class="fas fa-book-open me-2" style="color:#ff511a;"></i>Case Study Content
                </h6>
                <div class="d-flex flex-column gap-4">
                    <div>
                        <label class="form-label" style="font-size:13px;font-weight:600;color:#374151;">The Challenge <span style="color:#ff511a;">*</span></label>
                    ...
                    <div>
                        <label class="form-label" style="font-size:13px;font-weight:600;color:#374151;">Our Solution <span style="color:#ff511a;">*</span></label>
                    ...
                    <div>
                        <label class="form-label" style="font-size:13px;font-weight:600;color:#374151;">Results / Metrics <span style="color:#ff511a;">*</span></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
            <div class="card-body p-4">
                ...
                <label style="display:block;border:2px dashed #e5e7eb;border-radius:8px;padding:20px;text-align:center;cursor:pointer;transition:border-color .2s;"
                       onmouseover="this.style.borderColor='#ff511a'" onmouseout="this.style.borderColor='#e5e7eb'">
                ...
                @endif
                @else
                <label style="display:block;border:2px dashed #e5e7eb;border-radius:8px;padding:12px;text-align:center;cursor:pointer;" onmouseover="this.style.borderColor='#ff511a'" onmouseout="this.style.borderColor='#e5e7eb'">
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
            <div class="card-body p-4">
                ...
                @endif
                @else
                <label style="display:block;border:2px dashed #e5e7eb;border-radius:8px;padding:10px;text-align:center;cursor:pointer;" onmouseover="this.style.borderColor='#ff511a'" onmouseout="this.style.borderColor='#e5e7eb'">
        ...
        {{-- Save --}}
        <button type="submit" class="btn w-100" style="background:#ff511a;color:#fff;font-weight:700;border-radius:10px;padding:13px;font-size:15px;">
