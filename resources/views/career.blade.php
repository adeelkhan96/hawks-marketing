...
.career-job-card:hover { box-shadow:0 12px 40px rgba(33,39,65,.14); transform:translateY(-4px); border-left-color:#ff511a; }
...
.why-icon { width:60px; height:60px; border-radius:14px; background:rgba(255,81,26,.1); display:flex; align-items:center; justify-content:center; margin:0 auto 18px; }
.why-icon i { color:#ff511a; font-size:24px; }
.step-num { width:44px; height:44px; border-radius:50%; background:#ff511a; color:#fff; font-size:18px; font-weight:800; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
</style>
@endsection
...
<section style="background:linear-gradient(135deg,#212741 0%,#1a2155 100%);padding:90px 0 80px;position:relative;overflow:hidden;">
    <div style="position:absolute;top:-80px;right:-80px;width:400px;height:400px;background:rgba(255,81,26,.07);border-radius:50%;"></div>
    <div style="position:absolute;bottom:-100px;left:-60px;width:300px;height:300px;background:rgba(255,81,26,.05);border-radius:50%;"></div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <h1 style="color:#fff;font-size:44px;font-weight:800;line-height:1.2;margin-bottom:18px;">
                    Build Your Career at<br><span style="color:#ff511a;">Hawks Marketing</span>
                </h1>
                ...
                <a href="#open-positions" style="display:inline-flex;align-items:center;gap:10px;background:#ff511a;color:#fff;padding:14px 30px;border-radius:10px;font-size:15px;font-weight:700;text-decoration:none;">
...
<section id="open-positions" style="background:#fff;padding:80px 0;">
    <div class="container">
        ...
        <div class="text-center py-5">
            <div style="width:70px;height:70px;background:rgba(255,81,26,.1);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
                <i class="fas fa-briefcase" style="font-size:28px;color:#ff511a;"></i>
            </div>
            ...
            <a href="{{ route('contact') }}" style="display:inline-flex;align-items:center;gap:8px;background:#ff511a;color:#fff;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:700;text-decoration:none;">
            ...
            <div class="col-lg-6">
                <a href="{{ route('career.job', $job->id) }}" class="career-job-card">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div>
                            <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px;">
                                <span style="background:rgba(255,81,26,.1);color:#ff511a;font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">
                                    {{ $job->department }}
                                </span>
                        ...
                        <div style="width:44px;height:44px;background:rgba(255,81,26,.1);border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <i class="fas fa-arrow-right" style="color:#ff511a;"></i>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-3" style="font-size:12px;color:#9ca3af;padding-top:14px;border-top:1px solid #f3f4f6;">
                        ...
                        <span><i class="fas fa-clock me-1" style="color:#ff511a;"></i>{{ $job->experience }}</span>
                        @if($job->salary)
                        <span><i class="fas fa-money-bill-wave me-1" style="color:#ff511a;"></i>{{ $job->salary }}</span>
                        @endif
                        @if($job->deadline)
                        <span><i class="fas fa-calendar-alt me-1" style="color:#ff511a;"></i>Apply by {{ $job->deadline->format('d M Y') }}</span>
                        @endif
                    </div>
                </a>
            </div>
...
<section style="background:#212741;padding:80px 0;">
    <div class="container">
        <div class="section-heading" style="margin-bottom:50px;">
            <h6 style="color:#ff511a;">OUR PROCESS</h6>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div style="text-align:center;padding:10px;">
                    <div style="width:52px;height:52px;border-radius:50%;background:#ff511a;color:#fff;font-size:20px;font-weight:800;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">{{ $i+1 }}</div>
